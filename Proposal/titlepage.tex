...
\newcommand\subtitle{The effect of the landscape on \\tree seed diversity, dispersal and guild in naturally regenerating tropical forests}
...
\begin{titlepage}
    ...
    {\large \bfseries \subsubtitle} \\[0.2 cm]
